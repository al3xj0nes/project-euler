            ...
            for (int i = 0; i < 20; i++)
            {
                for (int j = 0; j < 20; j++)
                {
                    ...
                    if (j >= 3) // j Must be >=3 to be far enough from left edge.
                    {
                        ...
                        if (tempCalc > greatestProduct)
                        {
                            greatestProductNode[0] = i;
                            greatestProductNode[1] = j;
                            greatestProductType = "LEFT";
                            greatestProduct = tempCalc;
                        }
                    }
                    // RIGHT
